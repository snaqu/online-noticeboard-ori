...
//        $_SESSION['zap_rej'] = $data_rejestracji;
        ...
        if ($ok == true) {
            ...
            if (mysqli_connect_errno() != 0) {
                ...
                $wynik = @$polaczenie->query("INSERT INTO uzytkownicy (id_uzytkownika, login, haslo, email, nr_telefonu, data_rejestracji, imie, nazwisko, adres, miasto, kod_pocztowy) VALUES ('', '$login','$haslo_hash','$email','$nr_telefonu', '$today', '$imie','$nazwisko','$adres','$miasto','$kod_pocztowy')");
