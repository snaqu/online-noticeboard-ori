                    ...
                    <div class="col-8">
                        ...
                        <div class="card" style="width: 100%;">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center"> Lorem ipsum dolor sit amet.<button type="button" class="btn btn-outline-primary">Zobacz</button></li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">Dapibus ac facilisis in <button type="button" class="btn btn-outline-primary">Zobacz</button></li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">Vestibulum at eros <button type="button" class="btn btn-outline-primary">Zobacz</button></li>
                            </ul>
                            </div>
                        </div>
